...
#define NRF_CE(x) {if (x){GPIO_SetBits(GPIOB, GPIO_Pin_1);}else{GPIO_ResetBits(GPIOB, GPIO_Pin_1);}} 
#define NRF_SCN(x) {if (x){GPIO_SetBits(GPIOA, GPIO_Pin_4);}else{GPIO_ResetBits(GPIOB, GPIO_Pin_4);}} 
#define NRF_SCK(x) {if (x){GPIO_SetBits(GPIOA, GPIO_Pin_5);}else{GPIO_ResetBits(GPIOB, GPIO_Pin_5);}} 
#define NRF_MOSI(x) {if (x){GPIO_SetBits(GPIOA, GPIO_Pin_7);}else{GPIO_ResetBits(GPIOB, GPIO_Pin_7);}} 
//#define NRF_MISO(x) {if (x){GPIO_SetBits(GPIOB, GPIO_Pin_15);}else{GPIO_ResetBits(GPIOB, GPIO_Pin_15);}} 
//#define NRF_CS(x) {if (x){GPIO_SetBits(GPIOB, GPIO_Pin_15);}else{GPIO_ResetBits(GPIOB, GPIO_Pin_15);}} 
#define NRF_MISO()  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_6)
#define NRF_WIRQ() GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_2)
...
#define NRF24L01_CSN_CLK               RCC_APB2Periph_GPIOA
#define NRF24L01_CSN_PIN               GPIO_Pin_4
#define Set_NRF24L01_CSN()  {GPIO_SetBits(NRF24L01_CSN_PORT,NRF24L01_CSN_PIN);}
#define Clr_NRF24L01_CSN()  {GPIO_ResetBits(NRF24L01_CSN_PORT,NRF24L01_CSN_PIN);}  
...
extern u8 g_EngChan[4];
extern u16 g_EngDuty[4];
extern u16 g_EngDutyImp[4];
